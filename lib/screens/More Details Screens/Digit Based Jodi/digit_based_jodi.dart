...
class DigitBasedPage extends StatelessWidget {
  DigitBasedPage({super.key});
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            nameColumn(titleText: "BIDS".tr, subText: "0"),
            nameColumn(titleText: "POINTS_TXT".tr, subText: "0"),
            SizedBox(
